    ...
    <screen-adapter>
      <div class="home">
        ...
        <div class="top-box">
          <!--顶部左侧内容-->
          <div class="t-left">
            <span class="t-left-title">百千万工程数据可视化驾驶舱12313131213</span>
        ...
        <div class="left-box">
          ...
          <div class="echarts-box">
            <Echarts v-if="pieOptions" :key="pieOptions" :id="'pie'" :width="'100%'" :options="pieOptions"
                     :height="'100%'"/>
          </div>
          <div class="tab-box">
            <ul>
              <li v-for="(item, index) in tabList" :key="item.typeName" :class="{ active: currTabIndex === index }"
        ...
        <div class="right-box">
          ...
          <div class="box1">
            ...
            <div class="echarts-box">
              ...
              <Echarts v-if="barOptions1" :key="barOptions1" :id="'bar5'" :width="'100%'" :options="barOptions1"
                       :height="'100%'"/>
            </div>
          </div>
          <div class="common-title">集体经济</div>
          <div class="echarts-box">
            <Echarts v-if="barOptions" :key="barOptions" :id="'bar'" :width="'100%'" :options="barOptions"
                     :height="'200px'"/>
          </div>
...
.right-box {
  ...
  .box1 {
    ...
    & > .box-1-1:nth-child(2), & > .box-1-1:nth-child(4) { /* 选择第一个和第三个子元素 */
      .text {
        background-color: #45BDFE;
      }
    }

    & > .box-1-1:nth-child(1), & > .box-1-1:nth-child(3) { /* 选择第二个和第四个子元素 */
      .text {
